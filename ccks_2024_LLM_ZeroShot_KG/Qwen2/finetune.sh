...
MODEL="/root/Qwen2-7B-Instruct-AWQ" # Set the path if you do not want to load from huggingface directly
...
#DATA="/root/autodl-tmp/IEPile/ccks/train.jsonl"
DATA="/root/autodl-tmp/InstructIE/ccks/train.jsonl"
